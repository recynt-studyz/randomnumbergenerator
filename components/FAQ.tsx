      ...
      <div className="space-y-3">
        {questions.map((faq, i) => (
          <details key={i} className="group rounded-xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-[#1e293b]">
            <summary className="flex cursor-pointer list-none items-center justify-between px-5 py-4 font-medium text-gray-800 dark:text-[#e2e8f0] hover:text-violet-700 dark:hover:text-violet-400 transition">
              {faq.q}
